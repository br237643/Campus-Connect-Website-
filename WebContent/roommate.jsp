...
<body class="feeding">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="RoomMateFeed" class="tabbold">Roommate
				Finder</a></li>
 ...
 %>
												...
												<%
													...
													ArrayList<GetRoomMateFeed> newsfeed = new ArrayList<GetRoomMateFeed>();
													ArrayList<GetRoomMateFeed> comment = new ArrayList<GetRoomMateFeed>();
												...
												<div class="panel panel-default">
													...
													<div class="panel-body">
														<p id="o">
															...
															if(((String) session.getAttribute("email")).equals(newsfeed.get(i).getEmail())) {
															%><a href="Deletepostnew?linkname=<%=newsfeed.get(i).getID()%>">Delete</a>
														<% } %>
														<div id="a"></div>
														<div id="d"></div>
														<div id="r"></div>
